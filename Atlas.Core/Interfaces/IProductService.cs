...
namespace Atlas.Core.Interfaces
{
    public interface IProductService
    {
        ...
        Task<bool> CreateProductAsync(Products product, IEnumerable<int>? categoryIds = null, IEnumerable<ProductVariant>? variants = null);
        
        Task<bool> UpdateProductAsync(Products product, IEnumerable<int>? categoryIds = null);
